...
public class WPStorePage extends TestSetUp{
	...
	@FindBy(xpath="//strong[@id='lblPrimaryCashback' and contains(text(),'Rs.')]")
	...
	public WPStorePage refreshStorePage(WebDriver driver) {
		try {
	...
	public WPStorePage verifypartner1loggedin()
	{
       ...
       String str = lnkMainCtaActivateCashback.getAttribute("href");		
		...
		System.out.println("User ID ="+id);
			...
			{			
				...
				lnkMainCtaActivateCashback.click();
