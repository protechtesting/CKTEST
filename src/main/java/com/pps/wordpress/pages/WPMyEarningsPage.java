...
public class WPMyEarningsPage extends TestSetUp{
	...
	@FindBy(xpath="//p[contains(text(),'Thanks. You also have Rs.500.00 Cashback earnings ready to be withdrawn. Would you like to combine them with these Rewards & redeem together via Gift Cards or Wallet transfer (not NEFT)?')]")
	private static WebElement paragraphMsgCombineCashBackRewards;
	//Verify presence of message Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cash back & redeem together via Gift Cards or Wallet transfer (not NEFT)?
	public WPMyEarningsPage verifyPresenceMessageToCombineCashBackAndRewards () {
		Log.info("Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page");
		reportStep("Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page", "INFO");
		presence=Utils.verifyElementPresence(paragraphMsgCombineCashBackRewards);
		if(presence) {
			Log.info("Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page");
			reportStep("Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page", "PASS");
		}else {
			Log.info("Unable to verify presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)?  In Pop Up on My Earning Page");
			reportStep("Unable to verify presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)?  In Pop Up on My Earning Page", "FAIL");
		}
	...
	@FindBy(xpath="//p[contains(text(),'Thanks. You also have Rs.500.00 Cashback earnings ready to be withdrawn. Would you like to combine them with these Rewards & redeem together via Gift Cards or Wallet transfer (not NEFT)?')]")
	private static WebElement paragraphMsgCombineCashBackRewards4;
	//Verify presence of message Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cash back & redeem together via Gift Cards or Wallet transfer (not NEFT)?
	public WPMyEarningsPage verifyPresenceMessageToCombineCashBackAndRewards4() {
		Log.info("Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page");
		reportStep("Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page", "INFO");
		presence=Utils.verifyElementPresence(paragraphMsgCombineCashBackRewards);
		if(presence) {
	...
	@FindBy(xpath="//p[contains(text(),'Thanks. You only have Rs.50.00 in your Rewards account. However, combining your Cashback earnings (Rs.200.00) you have reached the minimum limit of Rs.250.00. Would you like to redeem both your Cashback and Rewards earnings? Please note in this case, you will not be able to withdraw your Cashback via NEFT. You can withdraw Rewards + Cashback via Gift Cards or Wallet transfer only.')]")
	private static WebElement paragraphMsgCombineCashBackRewards2;
	//Verify presence of message Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cash back & redeem together via Gift Cards or Wallet transfer (not NEFT)?
	public WPMyEarningsPage verifyPresenceMessageToCombineCashBackAndRewards2 () {
		Log.info("Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page");
		reportStep("Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page", "INFO");
		presence=Utils.verifyElementPresence(paragraphMsgCombineCashBackRewards2);
		if(presence) {
			Log.info("Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page");
			reportStep("Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page", "PASS");
		}else {
	...
	@FindBy(xpath="//p[contains(text(),'Thanks. You only have Rs.200.00 in your Cashback account. However, combining your Rewards earnings (Rs.50.00) you have reached the minimum limit of Rs.250.00. Would you like to redeem both your Cashback and Rewards earnings? Please note in this case, you will not be able to withdraw your \r\n" + 
			"Cashback via NEFT. You can withdraw Rewards + Cashback via Gift Cards or Wallet transfer only.')]")
	private static WebElement paragraphMsgCombineCashBackRewards3;
	//Verify presence of message Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cash back & redeem together via Gift Cards or Wallet transfer (not NEFT)?
	public WPMyEarningsPage verifyPresenceMessageToCombineCashBackAndRewards3() {
		Log.info("Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page");
		reportStep("Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page", "INFO");
		presence=Utils.verifyElementPresence(paragraphMsgCombineCashBackRewards3);
		if(presence) {
			Log.info("Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page");
			reportStep("Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page", "PASS");
		}else {
	...
	//Verify presence of message Thanks. You also have Rs.500.00 Cashback earnings ready to be withdrawn. Would you like to combine them with these Rewards & redeem together via Gift Cards or Wallet transfer (not NEFT)?
	public WPMyEarningsPage verifyPresenceMessageToCombineCashBackPlusRewards () {
		Log.info("Locating message : Thanks. You also have Rs.500.00 Cashback earnings ready to be withdrawn. Would you like to combine them with these Rewards & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page");
		reportStep("Locating message : Thanks. You also have Rs.500.00 Cashback earnings ready to be withdrawn. Would you like to combine them with these Rewards & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page", "INFO");
		presence=Utils.verifyElementPresence(paragraphMsgCombineCashBackPlusRewards);
		if(presence) {
			Log.info("Successfully verified presence of message : Thanks. You also have Rs.500.00 Cashback earnings ready to be withdrawn. Would you like to combine them with these Rewards & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page");
			reportStep("Successfully verified presence of message : Thanks. You also have Rs.500.00 Cashback earnings ready to be withdrawn. Would you like to combine them with these Rewards & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on My Earning Page", "PASS");
		}else {
			Log.info("Unable to verify presence of message : Thanks. You also have Rs.500.00 Cashback earnings ready to be withdrawn. Would you like to combine them with these Rewards & redeem together via Gift Cards or Wallet transfer (not NEFT)?  In Pop Up on My Earning Page");
			reportStep("Unable to verify presence of message : Thanks. You also have Rs.500.00 Cashback earnings ready to be withdrawn. Would you like to combine them with these Rewards & redeem together via Gift Cards or Wallet transfer (not NEFT)?  In Pop Up on My Earning Page", "FAIL");
		}
	...
	public WPHomePage navigateToHomePage()
	{
