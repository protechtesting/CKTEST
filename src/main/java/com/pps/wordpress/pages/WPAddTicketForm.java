...
public class WPAddTicketForm extends TestSetUp{
	...
	public WPAddTicketForm verifyPresenceOfsuccessMessageSubmitTicket() throws InterruptedException {
	...
	@FindBy(xpath="//p[contains(text(),'Your cashback query has been submitted successfully.')]")
	...
	public WPAddTicketForm verifyPresenceOfinfoMessageQuerySubmittedSuccessFully() throws InterruptedException {
