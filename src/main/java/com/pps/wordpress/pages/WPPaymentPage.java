...
public class WPPaymentPage  extends TestSetUp{
	...
	public WPPaymentPage verifyPresenceMessageToCombineCashBackAndRewards() {
		String locator="Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String pass="Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String fail="Unable to verify presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)?  In Pop Up on Payment Page";
		Log.info(locator);
		reportStep(locator, "INFO");
	...
	@FindBy(xpath="//p[contains(text(),'Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)?')]")
	private static WebElement paragraphMsgCombineCashBackRewards1;
	//Verify presence of message Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cash back & redeem together via Gift Cards or Wallet transfer (not NEFT)?
	public WPPaymentPage verifyPresenceMessageToCombineCashBackAndRewards1() {
		String locator="Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String pass="Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String fail="Unable to verify presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)?  In Pop Up on Payment Page";
		Log.info(locator);
		reportStep(locator, "INFO");
		presence=Utils.verifyElementPresence(paragraphMsgCombineCashBackRewards1);
		if(presence) {
			Log.info(pass);
			reportStep(pass, "PASS");
		}else {
	...
	//Verify presence of message Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cash back & redeem together via Gift Cards or Wallet transfer (not NEFT)?
	public WPPaymentPage verifyPresenceMessageToCombineCashBackAndRewards2() {
		String locator="Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String pass="Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String fail="Unable to verify presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)?  In Pop Up on Payment Page";
		Log.info(locator);
	...
	//Verify presence of message Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cash back & redeem together via Gift Cards or Wallet transfer (not NEFT)?
	public WPPaymentPage verifyPresenceMessageToCombineCashBackAndRewards3() {
		String locator="Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String pass="Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String fail="Unable to verify presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)?  In Pop Up on Payment Page";
		Log.info(locator);
	...
	//Verify presence of message Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cash back & redeem together via Gift Cards or Wallet transfer (not NEFT)?
	public WPPaymentPage verifyPresenceMessageToCombineCashBackAndRewards4() {
		String locator="Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String pass="Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String fail="Unable to verify presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)?  In Pop Up on Payment Page";
		Log.info(locator);
		reportStep(locator, "INFO");
		presence=Utils.verifyElementPresence(paragraphMsgCombineCashBackRewards4);
		if(presence) {
			Log.info(pass);
			reportStep(pass, "PASS");
		}else {
	...
	@FindBy(xpath="//p[contains(text(),'Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)?')]")
	private static WebElement paragraphMsgCombineCashBackRewards5;
	//Verify presence of message Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cash back & redeem together via Gift Cards or Wallet transfer (not NEFT)?
	public WPPaymentPage verifyPresenceMessageToCombineCashBackAndRewards5() {
		String locator="Locating message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String pass="Successfully verified presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)? In Pop Up on Payment Page";
		String fail="Unable to verify presence of message : Thanks. You also have Rs.500.00 Rewards earnings ready to be withdrawn. Would you like to combine them with these Cashback & redeem together via Gift Cards or Wallet transfer (not NEFT)?  In Pop Up on Payment Page";
		Log.info(locator);
		reportStep(locator, "INFO");
		presence=Utils.verifyElementPresence(paragraphMsgCombineCashBackRewards5);
		if(presence) {
			Log.info(pass);
			reportStep(pass, "PASS");
		}else {
	...
	@FindBy(xpath = "(//strong[contains(text(),'Rs.250.00')])[2]")
	...
	@FindBy(xpath = "(//strong[contains(text(),'Rs.250.00')])[3]")
	...
	@FindBy(xpath = "//strong[contains(text(),'Rs.500.00')]")
	...
	@FindBy(xpath = "//p[contains(.,'( Cashback: Rs.250.00 , Rewards: Rs.250.00 )')]")
	...
	@FindBy(xpath = "//p[contains(text(),'*If sum of Confirmed Cashback + Confirmed Rewards is over Rs.250.00, you can request payment.')]")
	...
	@FindBy(xpath = "//p[contains(.,'However, if total Confirmed Rewards + Cashback is over Rs.250.00, they can be paid via Gift Cards.')]")
