...
import com.pps.wordpress.pages.WPContactUsPage;
 ...
 * <p>
 * {@link} <a href="https://pouringpounds.atlassian.net/jira/software/projects/PTA/boards/20/backlog?selectedIssue=PTA-21">Raise JIRA Issue Here</a>
 */
public class WP_VerifyContactUsPageFunctionality extends TestSetUp{
	...
	public void GU_verifyWhenUserSignUpSuccessfullyFromContactUsPageLandIntoContactUsPage() {
		...
		/*
		 * String otp=Utils.getOTPCode(mobile, driver); System.out.println(otp);
		 */
