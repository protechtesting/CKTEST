 ...
 * <p>
 * {@link} <a href="https://pouringpounds.atlassian.net/jira/software/projects/PTA/boards/20/backlog?selectedIssue=PTA-19">Raise JIRA Issue Here</a>
 */

public class WP_Verify_SearchPage_Functionality {
	...
	/**
	 *Verify search result when coupon only available
	 */
	public void verifySearchResultWhenCouponOnlyAvailable()
	{
